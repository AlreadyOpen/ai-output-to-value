...
2. Name the **decision sought** before collecting more evidence.
3. Put supporting internal material under `evidence/` or link to the organisation's existing controlled systems.
4. Evaluate `claim.json` with the interactive Claim Gate, CLI, WebMCP, or native MCP.
5. Record what would change the decision and the stop/restrict rule.
6. Keep the evidence private according to your organisation's access, retention, legal, security, and client obligations.
