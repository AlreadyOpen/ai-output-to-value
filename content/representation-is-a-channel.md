...
A director meeting a customer face-to-face may be useful. A sales lead joining a video call may be useful. An AI agent handling a transaction or information request may also be useful. The business question is not simply **who appeared at the interface**. It is **what capability, authority, substance, evidence, and outcome sat behind that interaction**.

> **Representation is a channel. Value comes from what the company can actually understand, deliver, stand behind, and improve.**

## 1. The boss can be a human representative of the company
...
That role matters. Human representation can provide benefits such as:
...
- escalation when automated processes are insufficient.

But these are **possible sources of value**, not automatic ones.

A face-to-face meeting does not make a weak proposal strong. A polished pitch does not make an unsupported claim true. A senior executive sitting in the room does not turn an unverified capability into a verified one.

The meeting channel and the underlying business substance should be evaluated separately.

## 2. Face-to-face presence is not an intrinsic value multiplier

Physical meetings can be valuable when they improve an outcome that matters. For example, they may shorten negotiation, surface hidden concerns, strengthen a relationship, or help participants resolve ambiguity.

But the value is in those effects—not in physical presence itself.

Useful questions are:

- Did the meeting improve understanding?
...
This principle applies equally to customer meetings, investor meetings, supplier meetings, workshops, conferences, and other business interactions.
...
- prepare questions for human decision-makers.

Cloudflare’s agentic-commerce material already describes AI agents searching, browsing, comparing, and buying on behalf of real customers. Its identity and wallet model is designed so a merchant can determine who authorised the agent and allow it to transact within defined limits.

Investors and investment teams can also use AI systems and agents for parts of research, screening, diligence, document review, monitoring, and analysis. The degree of autonomy and the legal authority to make or bind investment decisions depends on the organisation, mandate, jurisdiction, and controls in place.
...
A customer, investor, lender, insurer, regulator, or procurement team may increasingly have its own agents processing the same material.
...
- agents perform the routine exchange and humans enter only for exceptions, approvals, negotiations, or high-consequence decisions.

None of these patterns is automatically higher or lower value.

The question is whether the chosen channel improves the outcome while preserving appropriate authority, evidence, security, accountability, and recourse.
...
Likewise, inserting a human into a workflow does not automatically make the result more substantive.
...
→ **representation channels** — face-to-face meetings, calls, email, web interfaces, APIs, agent protocols
...
The distinction matters because **channel, actor, instrument, and outcome are not the same thing**.
...
## 8. What should still require a human?

There is no universal answer.

Human involvement may remain especially valuable where:

- goals are ambiguous;
- parties are negotiating exceptions;
- consequences are high;
- law or contract requires named human responsibility;
- trust depends on personal commitment;
- the system encounters novel circumstances;
- ethical or strategic judgement is central;
- an agent’s authority is intentionally limited.

The project should therefore avoid both extremes:

> “Humans must always be in the loop because humans are the source of value.”
