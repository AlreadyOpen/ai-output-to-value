...
IBM introduced the 1401 Data Processing System in 1959.

IBM's history page describes a business environment in which many smaller organisations were still performing labour-intensive accounting, inventory control, billing, and payroll with adding machines and paper ledgers. It separately gives payroll as an explicit example of work the 1401 could automate completely, through to printing cheques.

That was already a substantial transfer of clerical work from people into a machine.

Yet the business did not need to turn every payslip into a contributor list naming the computer that helped calculate it.
...
The same transition happened when personal computers entered ordinary office work.
...
Engineering work has also been progressively absorbed into digital systems.

A 1997 NIST publication describes CAD/CAM progressing from two-dimensional wireframe drafting systems in the 1970s toward parametric and feature-based solid modelling in the 1990s.

Modern engineering can involve CAD, BIM, finite-element analysis, CFD, meshing, optimisation, clash detection, quantity extraction, rendering, digital fabrication, and many other computational processes.
...
Most people know the organisation.
...
> **The organisation knows more collectively than any one participant knows individually.**

That was true before modern AI.

## The restaurant shows both sides of the argument
...
The restaurant is the operational unit presented to the customer.
...
The records can matter.

But none of those facts automatically requires them all to become part of the public attribution of the meal.

## The AI argument works in either direction

This gives two independent ways to think about AI.

If an AI agent is treated as something closer to a **team member** because it can analyse information, propose alternatives, use tools, produce substantial work, review outputs, or continue a workflow, ordinary organisations already do not name every team member on every output.

If AI is treated merely as a **tool**, ordinary organisations already do not name every tool, brand, model, version, or machine involved in every output.
...
A project director does not perform every calculation.

A principal engineer does not write every line of software.
