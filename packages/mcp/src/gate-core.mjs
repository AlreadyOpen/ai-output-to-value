...
// The claim gate as a pure module: no Node built-ins and no file or network access, so the
// same code runs in Node (the native MCP server), the browser bundle and WebMCP. Callers
// supply the rules (`gates`) and the claim schema; packages/mcp/src/core.mjs supplies the
// bundled copies for Node.
...
function schemaErrors(record, claimSchema) {
...
export function evaluateClaim(record, gates, claimSchema) {
